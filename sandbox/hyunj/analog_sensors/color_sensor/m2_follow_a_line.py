...
def main():
    ...
    # TOD O: 4: After running the code set the default white and black levels to a better initial guess.
    ...
    while True:
        ...
        if command_to_run == 'w':
            ...
            # TOD O: 2. Read the reflected_light_intensity property of the color sensor and set white_level to that value
            ...
            # TO O: 3. Read the reflected_light_intensity property of the color sensor and set black_level
...
def follow_the_line(robot, white_level, black_level):
    ...
    # TO DO: 5. Use the calibrated values for white and black to calculate a light threshold to determine if your robot
    ...
    while not robot.touch_sensor.is_pressed:
        if robot.color_sensor.reflected_light_intensity <50:
            robot.drive(400,400)
            time.sleep(0.1)
        else:
            robot.drive(400,-400)
