...
Authors: David Fisher and Lanxi Wang.  February 2017.
...
def main():
    ...
    # TO DO: 2. Create an MqttClient (no delegate needed since EV3 will only send data, so an empty constructor is fine)
