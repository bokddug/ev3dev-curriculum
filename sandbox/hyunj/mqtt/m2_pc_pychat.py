...
def main():
    ...
    my_name = "hyunj"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Lanxi"  # Used to set the topic that you will *publish to*
    ...
    # T ODO: 3. Call over a TA or instructor to sign your team's checkoff sheet.
    #
