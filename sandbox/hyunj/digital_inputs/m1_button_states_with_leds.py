...
# T ODO: 2. Have someone on your team run this program as is on the EV3 and make sure everyone understands the code.
...
def main():
    ...
    while True:
        # T ODO: 3. Implement the left, right, and up buttons as follows:
